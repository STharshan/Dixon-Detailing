...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "A truly professional job. I put my trust into Josh and it was 100% worth it, my car now looks like it’s been rolled out of the factory it’s that clean. I would absolutely recommend Josh and will definitely be back again to really keep on top of my car.",
    name: "Joshua O'Reilly",
  },
